...
class TestHeap(unittest.TestCase):
    ...
    def test_12_peek(self):
        Tree= MaxHeap(10)
        self.assertEqual(Tree.peek(),None)

    def test_13_peek(self):
        Tree = MaxHeap(10)
        Tree.enqueue(108)
        self.assertEqual(Tree.peek(), 108)
        self.assertEqual(Tree.get_size(),1)
    def test_enqueue_false(self):
        Tree = MaxHeap(2)
        Tree.enqueue(108)
        Tree.enqueue(108)
        self.assertFalse(Tree.enqueue(108))

    def test_dequeue_None(self):
        Tree= MaxHeap(108)
        self.assertEqual(Tree.dequeue(),None)
